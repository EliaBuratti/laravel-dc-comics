                ...
                <tbody>
                    @foreach ($comics as $comic)
                        <tr>
                            ...
                            <td>{{ $comic->title }}</td>
                            <td>
                                <a href="{{ route('trash.show', $comic->id) }}" class="btn btn-primary">View</a>
                                <a href="{{ route('trash.edit', $comic->id) }}" class="btn btn-info">Restore</a>
                                    ...
                                    <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-sm"
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                Warning! Are you sure to want delete permantly this comic?
                                            </div>
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-secondary"
                                                    data-bs-dismiss="modal">No!</button>
                                                <form action="{{ route('trash.destroy', $comic->id) }}" method="POST">
                                                    @csrf
                                                    @method('DELETE')
